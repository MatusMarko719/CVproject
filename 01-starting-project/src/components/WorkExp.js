...
const WorkExp = () => {
  return (
    <div>
      ...
      <div className={classes.leram}>
      <p className={classes.subhead}>1/2019-2/2021 BTL zdravotnícka technika ČR </p>
      ...
      <div className={classes.leram}>
      <p className={classes.subhead}>7/2017-12/2018 Rehabilitace Kosmická Praha ČR </p>
      <p className={classes.position}>Fyzioterapeut</p>
      </div>
      <div className={classes.leram}>
      <p className={classes.subhead}>6/2015-12/2017 Vojenský rehabilitačný ústav ČR </p>
      <p className={classes.position}>Fyzioterapeut</p>
      </div>
    </div>
  );
